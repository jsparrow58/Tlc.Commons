...
namespace SJ.Logging.Extensions
{
    ...
    public static class LoggerExtensions
    {
        ...
        public static void LogCriticalSource(
          ...
          params object[] args)
        {
            logger?.Log(LogLevel.Critical, eventId, args.Prepend(origin, filePath, lineNumber, message), exception,
        ...
        public static void LogTraceSource(
          ...
          params object[] args)
        {
            logger?.Log(LogLevel.Trace, eventId, args.Prepend(origin, filePath, lineNumber, message), exception,
              LoggerSourceFormatter.Format);
        }
        ...
        public static void LogDebugSource(
          ...
          params object[] args)
        {
            logger?.Log(LogLevel.Debug, eventId, args.Prepend(origin, filePath, lineNumber, message), exception,
              LoggerSourceFormatter.Format);
        }
        ...
        public static void LogErrorSource(
          ...
          params object[] args)
        {
            logger?.Log(LogLevel.Error, eventId, args.Prepend(origin, filePath, lineNumber, message), exception,
              LoggerSourceFormatter.Format);
        }
        ...
        public static void LogInformationSource(
          ...
          params object[] args)
        {
            logger?.Log(LogLevel.Information, eventId, args.Prepend(origin, filePath, lineNumber, message), exception,
              LoggerSourceFormatter.Format);
        }
